...
public class ServiceComanda {
    ...
    public void ServiceAddComanda(int nr, List<String> types, int luna, int zi) throws IOException, RepoException, JAXBException {
    ...
    public void ServiceRemoveComanda(int i) throws RepoException, JAXBException, IOException {
    ...
    public void ServiceUpdateComandaTorturi(int id, int nr, List<String> types) throws RepoException, IOException, JAXBException {
